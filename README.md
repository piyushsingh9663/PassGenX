...
6. Cryptographically secure randomness using Web Crypto API
7. Fully responsive UI for mobile and desktop
...
2. Dark mode support
3. Password history feature
4. Save generated passwords locally
